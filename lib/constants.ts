...
export const APP_SHORT_DESCRIPTION =
  "전국 축제를 월별·지역별 필터로 쉽고 빠르게 찾아보세요.";

export const APP_KEYWORDS =
  "서울축제, 부산축제, 제주축제, 벚꽃축제, 불꽃축제, 지역행사일정, 주말축제, 야시장일정, 박람회일정, 전시회일정, 아이와가볼만한축제, 커플데이트행사, 계절축제추천, 푸드페스티벌, 문화축제일정, 지역축제추천, 전국행사정보, 월별축제일정, 국내여행축제, 이벤트조아, 런조아";
