...
import DialogEditMember from "@/components/dialog/dialog-edit-member";
import {
  Table,
  TableBody,
  TableCell,
            ...
            {memberRows.length === 0 ? (
              ...
              memberRows.map((member, index) => (
                ...
                >
                  ...
                  <TableCell>
                    <div className="w-9 h-9 rounded-full overflow-hidden bg-gray-100 mx-auto">
                      <Image
                        ...
                        alt={`${member.full_name || "회원"}의 프로필 이미지`}
                        width={40}
                        height={40}
                  ...
                  <TableCell className="text-center">
                    {member.is_deleted && <Badge variant="red">탈퇴</Badge>}
                    {!member.is_deleted && <Badge variant="green">활성</Badge>}
                  </TableCell>
